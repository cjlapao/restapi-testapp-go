...
func (v *Version) PrintHeader() {
	fmt.Println("Ittech24 Deployment command line utility to manage and deploy several services")
	fmt.Println("running locally and in the cloud")
	fmt.Println("")
}
